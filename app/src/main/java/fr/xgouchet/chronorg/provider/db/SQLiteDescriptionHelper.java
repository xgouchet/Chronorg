...
public class SQLiteDescriptionHelper extends SQLiteOpenHelper {
    ...
    /**
     * Create a helper object to create, itemSelected, and/or manage a database. This method always returns
     ...
     *
     * @param context             to use to itemSelected or create the database
