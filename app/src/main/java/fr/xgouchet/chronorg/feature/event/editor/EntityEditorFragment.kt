...
class EventEditorFragment
    : EditorFragment<EventEditorViewModel>() {

    override val vmClass: Class<EventEditorViewModel> = EventEditorViewModel::class.java
    ...
    override fun configure(viewModel: EventEditorViewModel) {
